...
<body ng-app="myApp" class="container" ng-controller="UserProfileController as ctrl" background="resources/assets/images/bg.jpg">
	...
	<footer>
<br>
     <div class="row" style="color:Gray;background-color:#161819;text-align:center;">
	<div class="col-sm-4"><h5><b>Get to know Us</h5></b></div>
        <div class="col-sm-4"><h5><b>Let Us Help You</h5></b></div>
        <div class="col-sm-4"><h5><b>Connect Us</b></h5></div>	   
     </div>
     <div class="row"  style="color:Gray;background-color:#161819;text-align:center;">
	<div class="col-sm-4"><a href="#"><h5>About Us</h5></a></div>
        <div class="col-sm-4"><a href="#"><h5>Your Account</h5></a></div>
	...
	<div class="col-sm-4"><a href="#"><h5>Careers</h5></a></div>
        <div class="col-sm-4"><a href="#"><h5>Returns Center</h5></a></div>
        <div class="col-sm-4"><a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a></div>	   
     </div>
     <div class="row" style="color:Gray;background-color:#161819;text-align:center;">
	<div class="col-sm-4"><a href="#"><h5>Press Releases</h5></a></div>
        <div class="col-sm-4"><a href="#"><h5>100% Purchase Protection</h5></a></div>
        <div class="col-sm-4"><a href="#"><span class="fa fa-twitter-square" ></span></a></div>	   
     </div>
     <div class="row" style="color:Gray;background-color:#161819;text-align:center;">
          <div class="col-sm-4"><i class="fa fa-copyright" aria-hidden="true"></i>2016 FOCUS</div>
	  <div class="col-sm-4"><a href="#">Terms of Service</a></div>
